...
function deleteTodoItem(projectName, todoToDelete) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var item = _step.value;
      if (item.project === projectName) {
        for (var arrayItem in item.todo) {
