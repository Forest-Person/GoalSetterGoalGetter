...
function homePageRender() {
  ...
  var project = new _projectManager__WEBPACK_IMPORTED_MODULE_0__.projectManager();
  ...
  if (projectStorage !== null) {
    var _iterator = _createForOfIteratorHelper(projectStorage),
      _step;
    try {
...
var project = new _projectManager__WEBPACK_IMPORTED_MODULE_1__.projectManager();
project.createProject('seeing paris', 'best trip in town');
var newTodo = new _todoManager__WEBPACK_IMPORTED_MODULE_2__.todoManager();
