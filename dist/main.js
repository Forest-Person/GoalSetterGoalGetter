...
function homePageRender() {
  ...
  var editButtonForProjectsContainer = document.querySelector('.projectsDiv'); //render edit project name or desription popup form

  editButtonForProjectsContainer.addEventListener('click', function (event) {
