...
var projectManager = function projectManager() {
  ...
  var editProjectDescription = function editProjectDescription(projectName, newDescription) {
    var projectArray = JSON.parse(localStorage.getItem('projectArray'));
