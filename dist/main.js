...
/* harmony export */   "editTodoName": () => (/* binding */ editTodoName)
/* harmony export */ });
function editTodoName(projectObject, todoNameToEdit, newName) {
  projectObject.todo.forEach(function (obj) {
...
var projectManager = function projectManager() {
  ...
  var editProjectName = function editProjectName(projectName, newName) {
    var projectArray = JSON.parse(localStorage.getItem('projectArray'));
    var _iterator = _createForOfIteratorHelper(projectArray),
      _step;
    try {
...
/* harmony import */ var _editTodoListValues__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./editTodoListValues */ "./src/editTodoListValues.js");
/* harmony import */ var _deleteTodoList__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./deleteTodoList */ "./src/deleteTodoList.js");
