  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      if (obj.project) {
        ...
        var indiviualProjectContainer = document.createElement('div');
        ...
        var projectDiv = document.querySelector('.projectsDiv');
